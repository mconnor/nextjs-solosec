        ...
        <div className="MyPi">
            ...
            <div id="counseling">
                ...
                <p>
                    ...
                    © 2019 Symbiomix Therapeutics, LLC (A Lupin Company). All Rights Reserved. Solosec® is a registered
                    trademark of Symbiomix Therapeutics, LLC (A Lupin Company)<br/>
                    226679
                </p>
            </div>
            <div id="patientInfo">
                ...
                <p>
                    ...
                    All Rights Reserved solosec<sup>&reg;</sup> is a registered trademark of Symbiomix Therapeutics, LLC
                    (A Lupin
                    Company).<br/>
                    226679
                </p>
                ...
                <h4><span className="font-bold">Solosec<sup>®</sup> granules should be administered as follows:</span>
                    <ul>
                        <li>Sprinkle onto applesauce, yogurt or pudding. The granules will not dissolve. Consume all of
                            the granules within 30 minutes.
                        </li>
                ...
                <h4><span className="font-bold">Principal Display Panel - Display Carton</span><br/>
                    <span className="font-bold">USUAL DOSAGE: One packet.</span>
                    <ul>
                        <li>Sprinkle onto applesauce, yogurt or pudding. The granules will not dissolve. Consume all of
                            the granules within 30 minutes.
                        </li>
                ...
                <p className="font-bold">
                    ...
                    Oral Granules<br/>
                    Usual Dosage: <br/>
                    One 2 gram packet<br/>
                    Contains 12 individual cartons (NDC 27437-051-01) which contain one Solosec packet.<br/>
                    Rx Only<br/>
                ...
                <h4><span className="font-bold">Principal Display Panel - Individual Packet</span><br/>
                </h4>

                <p className="font-bold">
                    This packet is contained within<br/>
                    CARTON NDC 27437-051-01<br/>
                    solosec® 2g<br/>
                    secnidazole<br/>
                    2g <br/>
                    Oral Granules<br/>
                ...
                <p>
                    Solosec<sup>®</sup> granules should be administered as follows:
                </p>
                <p>
                    <ul>
                        <li>Sprinkle onto applesauce, yogurt or pudding. The granules will not dissolve. Consume all of
                ...
                <h4><span className="font-bold">Principal Display Panel - Individual Carton</span><br/>
                </h4>
