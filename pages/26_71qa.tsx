    ...
    return (
        ...
        >
            <QA>
                ...
                />
                <QuestionAnswer slug="q3"
                    q='Are there any lifestyle changes I should advise my patient to make during treatment with Solosec?'
                    a='<p>
                            Solosec has no alcohol restriction; <i>in vitro</i> drug alcohol studies showed it does not interact with aldehyde dehydrogenase.<sup>1</sup> There are no food restrictions, per the FDA-approved prescribing information, and Solosec has been tested not to interfere with combination ethinyl estradiol and norethindrone oral contraceptives.

                        </p>'
                />
                <QuestionAnswer slug="q4"
                    q='What potential AEs should I watch out for in my patients taking Solosec?'
                    a='<p>
                        Solosec is generally well-tolerated.<sup>1</sup> The most common adverse reactions observed in clinical trials in over 2% of patients taking Solosec were vulvovaginal candidiasis, headache, nausea, dysgeusia, vomiting, diarrhea, abdominal pain, and vulvovaginal pruritus.
                    </p>
                    <p>
